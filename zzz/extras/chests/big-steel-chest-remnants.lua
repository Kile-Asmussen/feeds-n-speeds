return {
  ...
  localised_name = { 'remnant-name', { fns_locale_key( 'entity-name', 'big-steel-chest') } },
  localised_description = { 'remnant-description',{ fns_locale_key( 'entity-description', 'big-steel-chest') } },
