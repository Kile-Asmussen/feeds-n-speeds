return {
  ...
  localised_name = { 'dying-explosion-name', { fns_locale_key('entity-name', 'small-radar') } },
  localised_description = { 'dying-explosion-description', { fns_locale_key('entity-description', 'small-radar') } },
