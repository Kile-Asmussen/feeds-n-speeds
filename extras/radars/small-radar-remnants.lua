return {
  ...
  localised_name = { 'remnant-name', { fns_locale_key('entity-name', 'small-radar') } },
  localised_description = { 'remnant-description', { fns_locale_key('entity-description', 'small-radar') } },
