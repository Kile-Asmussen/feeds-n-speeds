return {
  ...
  localised_name = { 'dying-explosion-name', { fns( 'entity-name', 'big-steel-chest') } },
  localised_description = { 'dying-explosion-description', { fns('entity-description', 'big-steel-chest') } },
