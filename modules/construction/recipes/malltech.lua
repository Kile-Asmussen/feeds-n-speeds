...
merge(data.raw.recipe, {
    ...
    ['display-panel'] = ingredients{ ['small-lamp'] = 1, ['copper-plate'] = 2, time = 1 },
     ...
     ['burner-inserter'] = ingredients{
          ['iron-stick'] = 2, ['iron-gear-wheel'] = 1,
     },
     ['inserter'] = ingredients{
          ['electronic-circuit'] = 1, ['burner-inserter'] = 2
     },
     ['long-handed-inserter'] = ingredients{
          ['steel-plate'] = 1, ['inserter'] = 2
     },
     ['fast-inserter'] = ingredients{
          ['electric-engine-unit'] = 1, ['inserter'] = 2
     },
     ['bulk-inserter'] = ingredients{
          ['advanced-circuit'] = 1, ['fast-inserter'] = 2
     },
     ['stack-inserter'] = ingredients{
          ['carbon-fiber'] = 1, ['processing-unit'] = 1, ['speed-module'] = 1, ['bulk-inserter'] = 2
     },
     ...
     ['fast-transport-belt'] = {
          ...
          ingredients = puts{
               ['copper-plate'] = 4, ['electric-engine-unit'] = 2, ['iron-gear-wheel'] = 5
          },
     },
     ...
     ['turbo-transport-belt'] = {
          __del = 'surface_conditions',
          results = puts{ ['turbo-transport-belt'] = 2 },
          ingredients = puts {
               ['molten-copper'] = 400, ['iron-gear-wheel'] = 20, ['electric-engine-unit'] = 10
          },
     },
     ...
     ['turbo-splitter'] = {
          __del = 'surface_conditions',
          ingredients = puts{
               ['turbo-transport-belt'] = 4, ['speed-module'] = 1, ['processing-unit'] = 1, ['low-density-structure'] = 10
          },
     },

-- Misc
     ['lab'] = ingredients{
          ['transport-belt'] = 3, ['inserter'] = 3, ['repair-pack'] = 3, ['sulfur'] = 3,
     },
    ...
    ['big-mining-drill'] = ingredients{
         ['processing-unit'] = 1, ['productivity-module'] = 2, ['electric-engine-unit'] = 30, ['tungsten-carbide'] = 20, ['molten-iron'] = 100, ['molten-copper'] = 100
    },
    ...
    ['steam-engine'] = ingredients{
         ['pipe'] = 2, ['engine-unit'] = 3, ['electric-engine-unit'] = 3,
    },
    ['offshore-pump'] = ingredients{
         ['electric-engine-unit'] = 1, ['pipe'] = 2
    },

    -- Assembling machines
    ['assembling-machine-1'] = ingredients{
         ['inserter'] = 3, ['electronic-circuit'] = 3, ['iron-chest'] = 1
    },
