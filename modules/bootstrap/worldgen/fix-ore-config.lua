...
table.merge(noise_expressions, {
    [fns 'sulfur-ore-regular-index'] = table.assign{'expression', val = regular_counts.expression},
    [fns 'sulfur-ore-starting-index'] = table.assign{'expression', val = starting_counts.expression},
})
