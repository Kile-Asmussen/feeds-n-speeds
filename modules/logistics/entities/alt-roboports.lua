...
sleeper.auto_unlocked_by = 'logistic-robotics'
...
log_only.logistics_radius = 30
log_only.charging_slots = 6
log_only.construction_radius = 35
...
log_only.auto_unlocked_by = 'logistics-system'
...
cons_only.auto_unlocked_by = 'construction-robotics'
